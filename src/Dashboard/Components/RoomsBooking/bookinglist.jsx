              ...
              <tbody>
                ...
                {[
                  ...
                  >
                    ...
                    <td><span className="text-nowrap">{booking.checkin}</span></td>
                    <td><span className="text-nowrap">{booking.checkout}</span></td>
                    <td><span className="text-nowrap">{booking.noofstay}</span></td>
